...
BEGIN_MESSAGE_MAP(Capp1App, CWinAppEx)
...
BOOL Capp1App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_app1TYPE,
...
void Capp1App::LoadCustomState()
{
}

void Capp1App::SaveCustomState()
{
}
